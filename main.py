...
GRAVITY = 20.0
MAX_JUMP_HEIGHT = 1.0 #the height of a block
...
def tex_coord(x,y, n=4):
    #return the bounding vertices of the texture squares
    m = 1.0/n
    dx = x*m
    dy = y*m
...
'''Accepts a position and returns the block containing that position
    Parameters : 
